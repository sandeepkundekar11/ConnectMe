  ...
  return (
    <div className="w-[calc(100vw-24rem)] h-[calc(100vh-4.5rem)]  relative">
      ...
      <div className="w-[calc(100vw-24rem)] h-20  bg-white  flex justify-start items-center fixed top-[4.5rem]">
        <UserStatus
          info={{
            name: userInfoMessages?.user.name,
            status: userInfoMessages?.user.status,
            profile: userInfoMessages?.user.profile,
          }}
        />
      </div>
      {/* all chat Container */}
      <div
        className="h-[calc(100%-4.5rem)] chatContainer  w-full bg-blue-200 flex  flex-col justify-end "
      ...
      <div className="fixed bottom-0 w-[calc(100vw-24rem)] h-auto  bg-white shadow-md flex justify-center items-end py-4">
        ...
        />
        <button
          className="rounded-full h-10 w-10 hover:bg-slate-200 flex justify-center items-center ml-2"
          onClick={SendMessage}
        >
          <svg
