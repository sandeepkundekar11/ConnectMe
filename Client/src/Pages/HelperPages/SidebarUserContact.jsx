...
const SidebarUserContact = ({
  ...
  return (
    <div
      className={`flex pt-2 hover:bg-slate-100 w-full  cursor-pointer px-4 py-2 ${
        userId === SelectedUserID && "bg-slate-200"
      }`}
      onClick={onClick}
    >
      ...
      <div className="ml-2">
        ...
        <p className="text-slate-500 text-sm">{message?.substring(0, 30)}...</p>
      </div>
    </div>
  );
};
