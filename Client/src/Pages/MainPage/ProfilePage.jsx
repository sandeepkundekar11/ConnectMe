    ...
    <div className="w-full min-h-screen h-full bg-blue-100 pt-[6rem] pb-4">
      ...
      <div className="md:w-4/5 h-44 bg-white mt-6 m-auto relative flex rounded-md">
        ...
        <div className="ml-3">
          ...
          <span className="mt-2 text-gray-500 text-sm flex">
            {" "}
            <p className="font-medium mr-3">290 Contacts</p>- 8 Groups
          </span>
            ...
            <div className="flex">
              {[1, 2, 3, 4, 5].map((ele) => {
                return (
                  <div
                    key={ele}
                    className="w-12 h-12 bg-slate-500 rounded-full border-2 -ml-5"
                  ></div>
                );
              })}
            </div>
          ...
          <div className="flex space-x-4 mt-4 items-center">
            <div className="flex text-gray-700 font-medium text-lg">
              <p>Private</p>
              <input
                className="ml-3"
                type="radio"
            ...
            <div className="flex text-gray-700 font-medium text-lg">
              <p>Public</p>
              <input className="ml-3" type="radio" name="privacy" id="" />
            </div>
          </div>
        </div>
      </div>
          ...
          <div className="md:ml-8 md:mt-0 mt-3  md:w-10/12 w-full relative">
            ...
            <div className="md:flex">
              <div className="md:w-2/4 w-full">
                ...
                <input
                  className="md:w-10/12 w-full h-10 outline-none border mt-2 pl-2 rounded-md"
                  type="text"
                  name=""
                  id=""
                />
            ...
            <div className=" md:w-11/12 w-full mt-6">
              ...
              <textarea
                rows={4}
                className="w-full mt-2 border outline-none rounded-md p-2 "
              ></textarea>
            </div>

            {/* edit button */}
            <div className="flex space-x-3">
              <button className="w-28 h-10 hover:bg-blue-600 bg-blue-500 rounded-lg border text-white">
                Save
              </button>
              <button className="w-28 h-10 hover:bg-red-600 bg-red-500 rounded-lg border text-white">
                cancel
              </button>
            </div>
          </div>
