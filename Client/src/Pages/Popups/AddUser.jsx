    ...
    return (
        <PopupProvider>
            <div className="w-96 h-[450px] bg-white rounded-md shadow-lg relative p-4">
                <button className="bg-white shadow-md hover:bg-slate-100 rounded-full absolute right-0 -mt-4 -mr-2">
                    <MdOutlineCancel className="w-8 h-8 " />
                </button>

                <div className="w-full h-full mt-3 pl-2 ">
                    <h1 className="text-start font-bold text-gray-700 text-xl">Search by Name</h1>
                    <div className="flex w-[95%] mt-4 bg-blue-50 h-10 items-center pl-1 rounded-md border">
                        <CiSearch className="w-8 h-8" />
                        <input className="w-full bg-transparent outline-none pl-2" type="text" placeholder="Search Contact" name="" id="" />
                    </div>
                    {/* user List */}
